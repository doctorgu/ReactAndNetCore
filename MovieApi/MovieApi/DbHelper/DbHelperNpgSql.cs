...
//    ///     using (NpgNpgsqlConnection conn = new NpgNpgsqlConnection(connectionString))
//    ///     {
//    ///         conn.Open();
...
//    {
//        private NpgNpgsqlConnection _conn;
//        private DbHelperOption _option = new DbHelperOption();
//        private NpgsqlTransaction _tran;

//        public DbHelperNpgsql(NpgNpgsqlConnection conn)
//        {
//            _conn = conn;
//        }
//        public DbHelperNpgsql(NpgsqlConnection conn, DbHelperOption option)
//        {
//            _conn = conn;
//            _option = option;
//        }
//        public DbHelperNpgsql(NpgsqlConnection conn, int CommandTimeout)
//        {
//            _conn = conn;
//            _option = new DbHelperOption() { CommandTimeout = CommandTimeout };
//        }
...
//            if (cmd.CommandTimeout != _option.CommandTimeout)
//            {
//                cmd.CommandTimeout = _option.CommandTimeout;
//            }
